...
<!-- This input is the highest-priority context for strategy re-refinement. -->
<!-- When editing via a GitHub PR: fill in this section, then mark the PR as Ready for Review. -->
<!-- The pipeline will pick up your input on the next run. -->
