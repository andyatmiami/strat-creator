...
<!-- Use the Staff Engineer / SME Input section below or a Feature Refinement PR to provide corrections or guidance. -->
...
*Add technical corrections, architectural direction, component preferences, or domain expertise below. Write in declarative, cumulative form — statements that remain valid across refinement iterations. This input takes priority over architecture context when they conflict. When editing via a GitHub PR: fill in this section, then mark the PR as Ready for Review.*
